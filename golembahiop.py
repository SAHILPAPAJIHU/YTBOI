...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = " ʙᴜʏ ᴋʀᴏ :- @BGMI_DDOS_OFFICIAL ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nJOIN BOTH CHANNELS TO GET FREE OR PAID ACCES \n\n @@BGMI_DDOS_OFFICIAL AND @golemfeedbacks \n\n NOW SEND YOUR USER ID TO @BGMI_DDOS_OFFICIAL FOR APPROVAL ")
...
3. MAKE SURE YOU JOINED @@BGMI_DDOS_OFFICIAL OTHERWISE NOT WORK
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ᴋʀᴏ :- @BGMI_DDOS_OFFICIAL ❄
'''
    bot.reply_to(message, response)
